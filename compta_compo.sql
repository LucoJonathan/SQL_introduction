...
CREATE TABLE `compo` (
  ...
  KEY `ID_ART` (`ID_ART`),
  KEY `ID_BON` (`ID_BON`),
  CONSTRAINT `ID_ART` FOREIGN KEY (`ID_ART`) REFERENCES `article` (`ID`),
  CONSTRAINT `ID_BON` FOREIGN KEY (`ID_BON`) REFERENCES `bon` (`ID`)
...
INSERT INTO `compo` VALUES (1,3,1,1),(2,4,5,2),(3,1,7,3);
